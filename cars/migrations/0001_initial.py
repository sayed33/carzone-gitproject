# Generated by Django 5.1.1 on 2025-06-22 12:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('New', 'New'), ('Used', 'Used'), ('Scrap', 'Scrap')], max_length=100)),
                ('price', models.IntegerField()),
                ('description', models.TextField(max_length=500)),
                ('odometer', models.IntegerField()),
                ('seats_no', models.IntegerField()),
                ('Transmission_type', models.CharField(choices=[('Automatic', 'Automatic'), ('Manual', 'Manual')], max_length=100)),
